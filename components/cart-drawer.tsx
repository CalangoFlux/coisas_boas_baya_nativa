...
import { X, Plus, Minus, Trash2, ShoppingCart, Calculator, Truck, Clock } from "lucide-react"
...
export default function CartDrawer({ brand, brandColor, accentColor = brandColor }: CartDrawerProps) {
  ...
  const generateWhatsAppMessage = (selectedShipping?: ShippingOption) => {
  ...
  const handleWhatsAppOrder = (selectedShipping?: ShippingOption) => {
    const message = generateWhatsAppMessage(selectedShipping)
                        ...
                        >
                          ...
                          <div className="text-right">
                            ...
                            <Button
                              size="sm"
                              variant="outline"
                              onClick={() => handleWhatsAppOrder(option)}
